...
export const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-[1000] px-4 md:px-8 py-6 md:py-8 flex justify-between items-center pointer-events-none">
      ...
      <div className="hidden lg:flex gap-2 pointer-events-auto glass px-4 py-1.5 rounded-full items-center">
        ...
        <button
          ...
          className="p-1.5 rounded-full hover:bg-white/10 transition-colors duration-300 text-text-muted hover:text-spidey-red"
